...
def get_securityGroup_list():
    ...
    print("%s, %s, %s, %s, %s, %s, %s" % ("Region", "Group-Name", "Group-ID", "In/Out", "Protocol", "Port", "Source/Destination"))
                ...
                for rule in inbound:
                    ...
                    if len(rule["IpRanges"]) > 0:
                        for ip_range in rule["IpRanges"]:
                            ...
                            else: wr.writerow([region,group_name,group_id,"Inbound",ip_protocol,to_port,cidr_block])
